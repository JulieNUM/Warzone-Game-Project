...
/**
 * Adapter class that allows a {@link ConquestMapFileManager} to be used as a {@link FileManager}.
 * This class delegates all file operations to the underlying {@code ConquestMapFileManager}.
 */
public class ConquestMapFileAdapter implements FileManager {

    private ConquestMapFileManager d_mapManager;

    /**
     * Constructs a {@code ConquestMapFileAdapter} with the specified {@code ConquestMapFileManager}.
     *
     * @param p_mapManager the map file manager to delegate file operations to
     */
    public ConquestMapFileAdapter(ConquestMapFileManager p_mapManager) {
